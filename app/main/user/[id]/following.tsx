...
import { useFollowing } from '@/features/user/hooks/useFollow';
...
export default function Following() {
  ...
  const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } = useFollowing(id);

  const following: User[] = data?.pages.flatMap((page) => page.data) || [];
  ...
  return (
    <View className="flex-1 bg-[#121212]">
      ...
      <View className="flex-row items-center p-4 border-b border-gray-800">
        ...
        <Text className="text-lg font-bold text-white ml-4">フォロー中</Text>
      </View>
